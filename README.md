...
<br>
Platform: Should work on any platform the Unity game engine supports except Android and WebGL (see [Notes](#notes) for more). (Tested on [Debian Linux](https://www.debian.org/) on a Steam Deck)
